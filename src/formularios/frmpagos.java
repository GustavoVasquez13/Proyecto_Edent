...
public class frmpagos extends internalFrameImagen {
...
private void mostrarpacientes() {
        try {
            ...
            modelo = Mostrarp.mostrarpacientepago();
            jtPacientes.setModel(modelo);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "PROBLEMAS AL CONSULTAR LOS DATOS DEL PACIENTE");
        }
    }
    /**
    ...
    private void jtPacientesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtPacientesMousePressed
        if(evt.getClickCount()==2){
            ...
            String apellido,id,nombre,pago;
            nombre=jtPacientes.getValueAt(fila, 1).toString();
            apellido=jtPacientes.getValueAt(fila, 2).toString();
            pago=jtPacientes.getValueAt(fila, 3).toString();
            id=jtPacientes.getValueAt(fila, 0).toString();
           
            

//            ExpedienteGeneral.fecha.setText(fecha);
            frmPagoconsulta.txtnombre.setText(nombre);
            frmPagoconsulta.txtid.setText(id);
            frmPagoconsulta.txtapellido.setText(apellido);
            frmPagoconsulta.txttotal.setText(pago);
          ...
          frmPagoconsulta.txtnombre.setEnabled(false);
          frmPagoconsulta.txtid.setEnabled(false);
          frmPagoconsulta.txtapellido.setEnabled(false);
          frmPagoconsulta.txttotal.setEnabled(false);
