...
public class frmayudaPP extends internalFrameImagen{
    ...
    private void initComponents() {
        ...
        lblReg.setText("Realizar una Compra ");
        ...
        lblEdit.setText("Agregar Nuevos Productos");
    ...
    private void lblEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEditMouseClicked
        this.lblMensaje.setText("<html><body><p ALIGN=\"justify\">Para <b>Agregar un Nuevo Produto</b> debe de dar click sobre el boton de "
                ...
                + "para realizar exitosamente <b>Ingreso de un nuevo producto</b> especificado.</p></body></html>");
